...
# ------------------------------------------------------------
# 🌺 Ultimate Floating Hare Krishna Banner
# ------------------------------------------------------------
st.markdown("""
<style>
...
.tilak {
    animation: pulseTilak 2.2s infinite;
    font-size: 30px;
}
...
<div class="floating-banner">
    ...
    <span style="font-size:18px; font-weight:600;">
        🔔 Total Chants Today: <span style="color:#fffacd;">{{CHANT_COUNT}}</span>
    </span>
</div>

<br><br><br><br><br>

""".replace("{{CHANT_COUNT}}", str(st.session_state.get("mala", 0) + st.session_state.get("sets", 0) * 16))),
